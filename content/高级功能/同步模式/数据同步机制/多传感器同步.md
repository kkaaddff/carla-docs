...
图表来源
- [Docs/core_sensors.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/core_sensors.md#L1-L198)
- [Docs/ref_sensors.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/ref_sensors.md#L1-L768)
...
- [PythonAPI/examples/sensor_synchronization.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/examples/sensor_synchronization.py#L1-L124)
- [PythonAPI/examples/visualize_multiple_sensors.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/examples/visualize_multiple_sensors.py#L1-L357)
- [LibCarla/source/carla/client/detail/Simulator.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/client/detail/Simulator.h#L174-L219)
- [LibCarla/source/carla/client/detail/Episode.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/client/detail/Episode.h#L49-L98)
- [LibCarla/source/carla/streaming/detail/MultiStreamState.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/streaming/detail/MultiStreamState.h#L1-L147)
- [LibCarla/source/carla/Buffer.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/Buffer.h#L49-L293)
- [LibCarla/source/carla/Buffer.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/Buffer.cpp#L1-L14)
- [Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Sensor/WorldObserver.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Sensor/WorldObserver.cpp#L371-L400)
...
章节来源
- [Docs/adv_synchrony_timestep.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/adv_synchrony_timestep.md#L139-L186)
- [PythonAPI/examples/sensor_synchronization.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/examples/sensor_synchronization.py#L93-L118)
- [LibCarla/source/carla/client/detail/Simulator.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/client/detail/Simulator.h#L174-L219)
- [LibCarla/source/carla/streaming/detail/MultiStreamState.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/streaming/detail/MultiStreamState.h#L1-L147)
- [LibCarla/source/carla/Buffer.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/Buffer.h#L49-L293)
- [LibCarla/source/carla/Buffer.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/Buffer.cpp#L1-L14)
...
- 示例参考：
  - [PythonAPI/examples/sensor_synchronization.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/examples/sensor_synchronization.py#L30-L118)
  - [PythonAPI/test/smoke/test_sync.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/test/smoke/test_sync.py#L43-L69)
  - [PythonAPI/test/smoke/test_sync.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/test/smoke/test_sync.py#L104-L121)
...
- 示例参考：
  ...
  - [LibCarla/source/carla/ros2/publishers/CarlaLidarPublisher.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/ros2/publishers/CarlaLidarPublisher.cpp#L150-L170)
...
- 传感器数据丢失
  ...
  - 参考：
    - [PythonAPI/examples/sensor_synchronization.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/examples/sensor_synchronization.py#L100-L118)
    - [PythonAPI/test/smoke/test_sync.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/test/smoke/test_sync.py#L104-L121)
- 帧率不匹配
  - 现象：不同传感器的采样频率不一致，导致时间对齐困难。
  - 解决：统一设置 sensor_tick 或在应用层按帧聚合；验证传感器 tick 计数与总时间的关系。
  - 参考：
    - [PythonAPI/test/smoke/test_sensor_tick_time.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/test/smoke/test_sensor_tick_time.py#L51-L66)
- 数据包乱序
...
- LiDAR 点数统计异常
  ...
  - 参考：
    - [PythonAPI/test/smoke/test_lidar.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/test/smoke/test_lidar.py#L61-L89)
    - [PythonAPI/test/smoke/test_lidar.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/test/smoke/test_lidar.py#L88-L124)
...
## 附录
- 快速上手示例路径
  - 多传感器同步示例：[PythonAPI/examples/sensor_synchronization.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/examples/sensor_synchronization.py#L1-L124)
  - 多传感器可视化示例：[PythonAPI/examples/visualize_multiple_sensors.py](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/examples/visualize_multiple_sensors.py#L1-L357)
- 参考文档
  - 传感器与数据：[Docs/core_sensors.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/core_sensors.md#L1-L198)
  - 传感器参考参数：[Docs/ref_sensors.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/ref_sensors.md#L1-L768)
  - 同步与时步：[Docs/adv_synchrony_timestep.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/adv_synchrony_timestep.md#L139-L186)