...
**Section sources**
- [ecosys_synkrotron.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/ecosys_synkrotron.md#L17-L26)

### OASIS Data 平台分析
OASIS Data 是一个管理自动驾驶研发管道中大量数据的平台。它支持数据采集、匿名化、多级过滤、自动标注和场景重建。

**Section sources**
- [ecosys_synkrotron.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/ecosys_synkrotron.md#L28-L38)

### Synkrotron 工具和服务分析
Synkrotron 提供多种开发工具和服务，包括鱼眼相机、激光雷达物理模型、SOTIF 场景生成、地图创建、静态场景创建和动态场景重建。

**Section sources**
- [ecosys_synkrotron.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/ecosys_synkrotron.md#L40-L53)
...
**Diagram sources**
- [README.md](https://github.com/carla-simulator/carla/blob/ue5-dev/README.md#L196-L215)
...
**Section sources**
- [README.md](https://github.com/carla-simulator/carla/blob/ue5-dev/README.md#L22-L31)
