...
- [TrafficManager.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManager.h#L180-L213)
- [TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L333-L405)
- [Parameters.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/Parameters.h#L103-L296)
- [Parameters.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/Parameters.cpp#L21-L486)
- [adv_traffic_manager.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/adv_traffic_manager.md#L255-L354)
...
- [TrafficManager.h](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManager.h#L180-L213)
- [TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L333-L405)
- [Parameters.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/Parameters.cpp#L241-L481)
...
- 创建 TrafficManager 并设置端口
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L76-L113)
- 设置全局速度比例因子
  - 方法：global_percentage_speed_difference(percentage)
  - 示例：设置为 80%，表示目标速度为限速的 80%
  - 参考：[adv_traffic_manager.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/adv_traffic_manager.md#L327-L339)
- 设置单个车辆的速度百分比或期望速度
  - 方法：vehicle_percentage_speed_difference(actor, percentage)
  - 方法：set_desired_speed(actor, speed)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L82-L88)
- 设置全局与单个车辆的跟车距离
  - 方法：set_global_distance_to_leading_vehicle(distance)
  - 方法：distance_to_leading_vehicle(actor, distance)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L97-L98)
- 设置忽略信号/标志/行人类/车类的概率
  ...
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L95-L97)
- 设置保持慢车道与随机左右变道概率
  ...
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L98-L100)
- 设置自动变道与强制变道
  - 方法：auto_lane_change(actor, enable)
  - 方法：force_lane_change(actor, direction)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L91-L94)
- 设置车辆灯光自动更新
  - 方法：update_vehicle_lights(actor, do_update)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L88-L90)
- 设置混合物理模式与半径
  - 方法：set_hybrid_physics_mode(enabled)
  - 方法：set_hybrid_physics_radius(r)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L102-L103)
- 设置同步模式与随机种子
  - 方法：set_synchronous_mode(mode_switch)
  - 方法：set_random_device_seed(value)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L101-L104)
- 设置重生策略与边界
  - 方法：set_respawn_dormant_vehicles(mode_switch)
  - 方法：set_boundaries_respawn_dormant_vehicles(lower_bound, upper_bound)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L108-L109)
- 设置 OSM 模式
  - 方法：set_osm_mode(mode_switch)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L105-L105)
- 设置自定义路径与路线
  - 方法：set_path(actor, path, empty_buffer=True)
  - 方法：set_route(actor, route, empty_buffer=True)
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L106-L107)
...
- 设置全局速度比例因子
  ...
  - 参考：[TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L333-L347)
- 设置单个车辆的速度百分比或期望速度
  - 方法：SetPercentageSpeedDifference(actor, percentage)
  - 方法：SetDesiredSpeed(actor, value)
  - 参考：[TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L345-L347)
- 设置全局与单个车辆的跟车距离
  - 方法：SetGlobalDistanceToLeadingVehicle(distance)
  - 方法：SetDistanceToLeadingVehicle(actor, distance)
  - 参考：[TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L366-L372)
- 设置忽略信号/标志/行人类/车类的概率
  ...
  - 参考：[TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L382-L389)
- 设置保持慢车道与随机左右变道概率
  ...
  - 参考：[TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L390-L401)
- 设置自动变道与强制变道
  - 方法：SetAutoLaneChange(actor, enable)
  - 方法：SetForceLaneChange(actor, direction)
  - 参考：[TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L362-L364)
- 设置车辆灯光自动更新
  - 方法：SetUpdateVehicleLights(actor, do_update)
  - 参考：[TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L349-L352)
- 设置混合物理模式与半径
  - 方法：SetHybridPhysicsMode(mode_switch)
  - 方法：SetHybridPhysicsRadius(radius)
  - 参考：[TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L403-L405)
- 设置同步模式与随机种子
  - 方法：SetSynchronousMode(mode_switch)
  - 方法：SetSynchronousModeTimeOutInMiliSecond(time_ms)
  - 参考：[Parameters.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/Parameters.cpp#L147-L153)
- 设置重生策略与边界
  ...
  - 参考：[Parameters.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/Parameters.cpp#L33-L41)
- 设置 OSM 模式
  - 方法：SetOSMMode(mode_switch)
  - 参考：[Parameters.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/Parameters.cpp#L193-L195)
- 设置自定义路径与路线
  ...
  - 参考：[Parameters.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/Parameters.cpp#L197-L237)

章节来源
- [TrafficManagerLocal.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L333-L405)
- [Parameters.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/Parameters.cpp#L33-L41)
...
- 症状：变道过于频繁或异常
  ...
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L91-L100)
- 症状：忽略信号/标志导致冲突
  - 排查：核对忽略概率设置；在安全场景下调低该概率。
  - 参考：[TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L95-L97)
- 症状：确定性不一致
  - 排查：确保每次重载世界后重新设置随机种子；仅在同步模式下启用确定性。
  - 参考：[adv_traffic_manager.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/adv_traffic_manager.md#L367-L387)

章节来源
- [TrafficManager.cpp](https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/TrafficManager.cpp#L76-L113)
- [adv_traffic_manager.md](https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/adv_traffic_manager.md#L367-L387)
