...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManager.h#L1-L120" target="_blank">TrafficManager.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManager.cpp#L138-L236" target="_blank">TrafficManager.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.h#L1-L120" target="_blank">TrafficManagerLocal.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerRemote.h#L1-L60" target="_blank">TrafficManagerRemote.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerServer.h#L1-L120" target="_blank">TrafficManagerServer.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerClient.h#L1-L80" target="_blank">TrafficManagerClient.h</a>
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerBase.h#L1-L178" target="_blank">TrafficManagerBase.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.h#L1-L120" target="_blank">TrafficManagerLocal.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerRemote.h#L1-L60" target="_blank">TrafficManagerRemote.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerServer.h#L1-L120" target="_blank">TrafficManagerServer.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerClient.h#L1-L120" target="_blank">TrafficManagerClient.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManager.h#L1-L120" target="_blank">TrafficManager.h</a>
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L140-L249" target="_blank">TrafficManagerLocal.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerServer.h#L1-L120" target="_blank">TrafficManagerServer.h</a>
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L1-L249" target="_blank">TrafficManagerLocal.cpp</a>
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerRemote.cpp#L92-L210" target="_blank">TrafficManagerRemote.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerClient.h#L60-L220" target="_blank">TrafficManagerClient.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerServer.h#L120-L288" target="_blank">TrafficManagerServer.h</a>
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L140-L249" target="_blank">TrafficManagerLocal.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L116-L133" target="_blank">TrafficManagerLocal.cpp</a>
...
- 同步模式初始化与种子设置
  ...
  - 示例参考：<a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/tuto_G_traffic_manager.md#L1-L40" target="_blank">tuto_G_traffic_manager.md</a>

- 车辆注册与路径设定

  - 获取 TM 实例后，为车辆设置自动驾驶并设定路径，以引导车辆沿指定路径行驶。
  - 示例参考：<a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Docs/tuto_G_traffic_manager.md#L170-L227" target="_blank">tuto_G_traffic_manager.md</a>
...
- 局部模式（本地执行体）
  ...
  - 关键实现参考：
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManager.cpp#L138-L236" target="_blank">TrafficManager.cpp</a>
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.h#L1-L120" target="_blank">TrafficManagerLocal.h</a>
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerLocal.cpp#L1-L133" target="_blank">TrafficManagerLocal.cpp</a>

- 远程模式（连接远端 TM）

  - 当前客户端侧未发现显式“仅远程模式”的构造函数；通常由 TrafficManager 自动选择：若检测到远端 TM 则连接，否则创建本地实例。
  - 关键实现参考：
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManager.cpp#L176-L236" target="_blank">TrafficManager.cpp</a>
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerRemote.h#L1-L60" target="_blank">TrafficManagerRemote.h</a>
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerRemote.cpp#L1-L68" target="_blank">TrafficManagerRemote.cpp</a>

- 参数设置与行为控制
  - 可设置速度差异、车道偏移、跟车距离、信号忽略概率、强制/自动变道、混合物理模式、自定义路径/路线、重生策略等。
  - 接口定义参考：
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerBase.h#L50-L178" target="_blank">TrafficManagerBase.h</a>
  - 远端 RPC 绑定参考：
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerServer.h#L120-L288" target="_blank">TrafficManagerServer.h</a>
  - 远端 RPC 调用封装参考：
    - <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/trafficmanager/TrafficManagerClient.h#L60-L325" target="_blank">TrafficManagerClient.h</a>
