...
CARLA 模拟器提供了一个高度可配置的天气与光照系统，允许用户精确控制环境条件以进行自动驾驶算法的测试和验证。该系统通过`WeatherParameters`类定义各种天气属性，并通过`World`类进行管理和应用。天气系统不仅影响视觉传感器的感知效果，还通过物理准确的光照渲染影响整个场景的真实感。

天气系统的设计目标是为自动驾驶研究提供一个可控的环境测试平台，使研究人员能够在各种天气条件下评估算法的鲁棒性。从晴朗的正午到暴雨的黄昏，从薄雾弥漫到沙尘暴，CARLA 提供了广泛的天气条件选项。
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/rpc/WeatherParameters.h#L20-L178" target="_blank">WeatherParameters.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/client/World.h#L45-L242" target="_blank">World.h</a>

## 天气参数详解

CARLA 的天气系统由`WeatherParameters`类定义，包含 14 个可调节的参数，每个参数都有特定的物理意义和取值范围。这些参数共同决定了模拟环境的视觉外观和光照条件。
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/rpc/WeatherParameters.h#L84-L97" target="_blank">WeatherParameters.h</a>

#### 云量 (cloudiness)

- **取值范围**: 0.0 到 100.0
- **物理意义**: 天空被云层覆盖的程度
- **影响**: 0 表示完全晴朗的天空，100 表示完全被云层覆盖的阴天
- **默认值**: 0.0
...
- **物理意义**: 太阳在水平面上的方向
- **参考点**: 0 度为虚幻引擎确定的原点
- **典型值**: 正午时太阳位于南方（约 180 度）

#### 太阳高度角 (sun_altitude_angle)

- **取值范围**: -90.0 到 90.0 度
- **物理意义**: 太阳在垂直面上的高度
- **影响**: -90 度表示午夜，90 度表示正午
- **重要性**: 决定阴影长度和光照强度
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/rpc/WeatherParameters.h#L84-L97" target="_blank">WeatherParameters.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/docs/weather.yml#L13-L84" target="_blank">weather.yml</a>

## World 类中的天气控制

`World`类是 CARLA 模拟器中管理环境条件的核心类，提供了对天气系统的完整控制接口。通过`World`类的方法，用户可以获取当前天气状态、设置新的天气条件以及检查天气系统是否启用。
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/client/World.cpp#L86-L92" target="_blank">World.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/client/World.h#L90-L97" target="_blank">World.h</a>
...
CARLA 提供了 14 种预定义的天气预设，涵盖了从晴朗到恶劣天气的各种条件。这些预设是经过精心调校的参数组合，可以快速设置常见的天气场景。
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/rpc/WeatherParameters.cpp#L15-L37" target="_blank">WeatherParameters.cpp</a>
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/rpc/WeatherParameters.cpp#L15-L37" target="_blank">WeatherParameters.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/rpc/WeatherParameters.h#L26-L48" target="_blank">WeatherParameters.h</a>

## 天气与光照系统集成

CARLA 的天气系统与光照渲染系统深度集成，通过虚幻引擎的物理渲染管线实现真实的光照效果。这种集成确保了天气变化能够自然地影响场景的光照和视觉效果。
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Weather/Sky.h#L28-L47" target="_blank">Sky.h</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Weather/Weather.cpp#L76-L85" target="_blank">Weather.cpp</a>
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Weather/Weather.cpp#L38-L50" target="_blank">Weather.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Weather/Sky.cpp#L18-L31" target="_blank">Sky.cpp</a>
...
CARLA 提供了 Python API，使用户能够方便地控制天气系统。以下是一些常见的使用示例。
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/carla/src/Weather.cpp#L37-L69" target="_blank">Weather.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/examples/automatic_control.py#L57-L184" target="_blank">automatic_control.py</a>

## 动态天气系统

CARLA 支持动态天气系统，可以模拟随时间变化的天气条件。这种功能对于测试自动驾驶系统在变化环境中的适应能力至关重要。
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Weather/Weather.cpp#L93-L96" target="_blank">Weather.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/LibCarla/source/carla/rpc/WeatherParameters.cpp#L15-L37" target="_blank">WeatherParameters.cpp</a>
...
天气条件对传感器性能有显著影响，特别是对视觉传感器。CARLA 的天气系统专门设计来模拟这些影响，以测试自动驾驶系统的鲁棒性。

### 不同天气对传感器的影响

| 天气条件 | RGB 相机 | 深度传感器 | 语义分割 | 雷达     | 激光雷达 |
| -------- | -------- | ---------- | -------- | -------- | -------- |
| 晴朗     | 正常     | 正常       | 正常     | 正常     | 正常     |
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/PythonAPI/docs/weather.yml#L9-L10" target="_blank">weather.yml</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Weather/Weather.cpp#L38-L50" target="_blank">Weather.cpp</a>
...
为了在保持视觉真实感的同时确保模拟性能，CARLA 实现了多种优化策略。
...
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Weather/Weather.cpp#L68-L69" target="_blank">Weather.cpp</a>
- <a href="https://github.com/carla-simulator/carla/blob/ue5-dev/Unreal/CarlaUnreal/Plugins/Carla/Source/Carla/Weather/Sky.cpp#L18-L31" target="_blank">Sky.cpp</a>
